...
function NavBar() {
  ...
  return (
    <div>
      <div className="grid grid-cols-10 gap-16 items-center p-6 bg-black">
        <div className="col-span-7 flex items-center space-x-16 text-white">
        {/* 로고 */}
          <div
        ...
        <div className="col-span-3 flex justify-end space-x-4 items-center text-white">
          {/* 채팅 */}
          <Link
            to="/chat"
            className="font-medium text-sm flex items-center justify-center px-3 py-2 hover:bg-red-600 rounded-lg transition duration-300"
          >
            실시간 채팅 바로가기 💬
          </Link>
          {/* 내 좋아요 리스트 */}
          ...
          <div
            onClick={handleClick}
            className="bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm py-2 px-4 flex items-center justify-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 cursor-pointer transition duration-300"
          >
            로그아웃
          </div>
        </div>
