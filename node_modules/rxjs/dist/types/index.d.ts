...
export { animationFrames } from 'rxjs/internal/observable/dom/animationFrames';
...
export { NotFoundError } from 'rxjs/internal/util/NotFoundError';
export { ObjectUnsubscribedError } from 'rxjs/internal/util/ObjectUnsubscribedError';
export { SequenceError } from 'rxjs/internal/util/SequenceError';
export { TimeoutError } from 'rxjs/internal/operators/timeout';
...
export { connectable } from 'rxjs/internal/observable/connectable';
...
export { config, GlobalConfig } from 'rxjs/internal/config';
...
export { onErrorResumeNextWith } from 'rxjs/internal/operators/onErrorResumeNextWith';
...
export { repeat, RepeatConfig } from 'rxjs/internal/operators/repeat';
